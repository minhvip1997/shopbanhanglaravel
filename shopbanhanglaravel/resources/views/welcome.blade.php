                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                ?>
                                <li><a href="{{URL::to('/payment')}}"><i class="fa fa-crosshairs"></i>Thanh Toan</a></li>
                                <?php
                            }else{
                                ?>
                                <li><a href="{{URL::to('/login-checkout')}}"><i class="fa fa-crosshairs"></i>Thanh Toan</a></li>
                                <?php
                            }
                                ?>
                                ...
                                if($customer_id!=NULL){
                                ?>
                                <li><a href="{{URL::to('/logout-checkout')}}"><i class="fa fa-lock"></i>Dang Xuat</a></li>
                                <?php
                            }else{
                                ?>
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="{{URL::to('/show-cart')}}">Gio Hang</a></li>
                    ...
                    <div class="col-sm-4">
                        <form action="{{URL::to('/tim-kiem')}}" method="POST">
                           ...
                           <div class="search_box pull-right">
                            ...
                            <input type="submit" name="search_items" name="search_items"class="btn btn-success btn-sm" value="Tim Kiem">
                        </div>
                        </form>
