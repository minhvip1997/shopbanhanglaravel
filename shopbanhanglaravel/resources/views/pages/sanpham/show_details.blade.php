...
<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Dieu Kien:</b> Hang moi 100%</p>
								<p><b>Thuong Hieu:</b> {{$value->brand_name}}</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								...
								<li><a href="#companyprofile" data-toggle="tab">Chi Tie San Pham</a></li>
					...
					<div class="recommended_items"><!--recommended_items-->
						<h2 class="title text-center">San Pham Goi Y</h2>
